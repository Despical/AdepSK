...
public class ExpressionSyntaxInfo extends CustomSyntaxSection.SyntaxData {
	...
	public static ExpressionSyntaxInfo create(File script, String pattern, int matchedPattern, boolean alwaysPlural,
		...
		return new ExpressionSyntaxInfo(script, newPattern.toString(), matchedPattern,
				inheritedSingles.stream().mapToInt(i -> i).toArray(), alwaysPlural, adaptArgument, property);
	}
	...
	public String toString() {
		return String.format("%s (singles: %s, plural: %s, adapt: %s, property: %s)", getPattern(),
				Arrays.toString(inheritedSingles), alwaysPlural, adaptArgument, property);
	}
	...
	public boolean equals(Object o) {
		...
		return alwaysPlural == that.alwaysPlural && adaptArgument == that.adaptArgument && property == that.property
				&& Arrays.equals(inheritedSingles, that.inheritedSingles)
				&& Objects.equals(getScript(), that.getScript()) && Objects.equals(getPattern(), that.getPattern());
	}
