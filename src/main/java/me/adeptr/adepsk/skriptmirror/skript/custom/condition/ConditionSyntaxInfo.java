...
public class ConditionSyntaxInfo extends CustomSyntaxSection.SyntaxData {
	...
	public static ConditionSyntaxInfo create(File script, String pattern, int matchedPattern, boolean inverted,
			boolean property) {
		return new ConditionSyntaxInfo(script, SkriptMirrorUtil.preprocessPattern(pattern), matchedPattern, inverted,
				property);
	}
	...
	public boolean equals(Object o) {
		...
		return inverted == that.inverted && property == that.property && Objects.equals(getScript(), that.getScript())
