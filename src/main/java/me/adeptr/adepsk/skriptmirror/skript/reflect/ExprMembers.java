...
public class ExprMembers extends SimpleExpression<String> {
	...
	protected String[] get(Event e) {
		return Arrays.stream(target.getArray(e)).map(SkriptMirrorUtil::toClassUnwrapJavaTypes).flatMap(mapper)
				.map(JavaUtil::toGenericString).distinct().toArray(String[]::new);
	}
