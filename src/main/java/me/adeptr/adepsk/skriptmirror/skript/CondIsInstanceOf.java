...
public class CondIsInstanceOf extends Condition {
	static {
		Skript.registerCondition(CondIsInstanceOf.class, "%objects% (is|are) [a[n]] instance[s] of %javatypes%",
	...
	public boolean check(Event e) {
		return objects.check(e,
				o -> type.check(e, t -> t.getJavaClass().isAssignableFrom(SkriptMirrorUtil.getClass(o)), isNegated()));
	}
