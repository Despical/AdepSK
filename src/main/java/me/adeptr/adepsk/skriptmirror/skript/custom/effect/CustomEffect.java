package me.adeptr.adepsk.skriptmirror.skript.custom.effect;
...
public class CustomEffect extends Effect {
	...
	private EffectTriggerEvent invokeEffect(Event e) {
		...
		EffectTriggerEvent effectEvent = new EffectTriggerEvent(e, exprs, which.getMatchedPattern(), parseResult,
				which.getPattern(), getNext());
		if (trigger == null) {
