...
import me.adeptr.adepsk.events.AnvilGUICloseEvent;
import me.adeptr.adepsk.events.AnvilGUICompleteEvent;
...
public class EffAnvilGUI extends Effect {
	...
	static {
		Registry.newEffect(EffAnvilGUI.class, "open anvil gui with %itemstack% and name %string% to %player%");
	}
