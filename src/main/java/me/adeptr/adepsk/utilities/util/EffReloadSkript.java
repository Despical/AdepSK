...
public class EffReloadSkript extends Effect {
	...
	protected void execute(Event e) {
		File f = new File("plugins" + File.separator + "Skript" + File.separator + "scripts" + File.separator
				+ str.getSingle(e).replaceAll(".sk", "") + ".sk");
		if (f.exists()) {
			if (!f.isDirectory()) {
				unloadScript(f);
			...
			Main.prSysE("'" + f + "' doesn't exist!", getClass().getSimpleName());
		}
	}
