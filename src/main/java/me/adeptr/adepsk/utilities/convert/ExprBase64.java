...
public class ExprBase64 extends SimpleExpression<String> {
	...
	protected String[] get(Event e) {
		if (ty == 0) {
			return new String[] {
					Base64.getEncoder().encodeToString(b64.getSingle(e).getBytes(StandardCharsets.UTF_8)) };
		} else {
			return new String[] {
					new String(Base64.getDecoder().decode(b64.getSingle(e).getBytes(StandardCharsets.UTF_8))) };
		}
	}
