...
public class ExprRgbToHex extends SimpleExpression<String> {
	...
	protected String[] get(Event e) {
		String rgb = Integer.toHexString(new Color(Integer.parseInt(r.getSingle(e).toString()),
				Integer.parseInt(g.getSingle(e).toString()), Integer.parseInt(b.getSingle(e).toString())).getRGB());
