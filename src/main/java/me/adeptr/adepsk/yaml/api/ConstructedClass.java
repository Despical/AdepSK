package me.adeptr.adepsk.yaml.api;
...
public abstract class ConstructedClass<T> extends AbstractConstruct {
	 ...
	 * 
	 * @param values the serialized map
	...
	public Object construct(Node node) {
		final Map<Object, Object> values = Main.getInstance().getConstructor().constructMap((MappingNode) node);
