...
public class CondYamlIsLoaded extends Condition {
	...
	static {
		Skript.registerCondition(CondYamlIsLoaded.class, "y[a]ml[s] %strings% (is|are) loaded",
	...
	public String toString(final @Nullable Event e, final boolean debug) {
		return "yaml " + file.toString(e, debug) + (file.isSingle() ? " is " : " are ")
				+ (isNegated() ? "not loaded" : "loaded");
	}
