...
public class ActionBarNew implements ActionBarAPI {
	...
	public void sendActionBar(Player player, String message)
		...
		Object chatBaseComponent = clsIChatBaseComponent.getClasses()[0].getMethod("a", String.class).invoke(null,
				"{\"text\": \"" + message + "\"}");
		// Object chatBaseComponent =
		// reflection.getNMSClass("IChatBaseComponent$ChatSerializer").getMethod("a",
		// String.class).invoke(null, "{\"text\": \"" + message + "\"}");
		Object chatMessageType = clsChatMessageType.getMethod("valueOf", String.class).invoke(null, "GAME_INFO");
		Object packetPlayOutChat = ReflectionUtils.getNMSClass("PacketPlayOutChat")
