...
/**
 * Just a simple reflection class, just to not depend on Skript 2.2+ (I think it
 * is the only thing I use from it)
 * 
 * @author
 */
public class ReflectionUtils {
	 ...
	 * @param obj   - The instance of class, you can use null if the field is
	 *              static.
	...
	/**
	 * Use to get a object from a private field. If it will return null in case it
	 * was unsuccessful.
	 * 
	...
	public static Class<?> getNMSClass(String classString) {
		...
		try {
			...
			Bukkit.getLogger().warning(
					"Unable to get NMS class \'" + name + "\'! You are probably running an unsupported version!");
			return null;
		}
		return nmsClass;
	}
	...
	public static Object getHandle(Object obj) throws SecurityException, NoSuchMethodException, NoSuchFieldException,
	...
	public static Object getNMSBlock(Block block) {
		try {
			Method method = ReflectionUtils.getOBCClass("util.CraftMagicNumbers").getDeclaredMethod("getBlock",
					Block.class);
			method.setAccessible(true);
