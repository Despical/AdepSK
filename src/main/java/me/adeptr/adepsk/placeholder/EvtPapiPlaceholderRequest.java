package me.adeptr.adepsk.placeholder;
...
public class EvtPapiPlaceholderRequest extends SkriptEvent {
	...
	static {
		Skript.registerEvent("Placeholder Request", EvtPapiPlaceholderRequest.class, PlaceholderAPIEvent.class,
		...
		EventValues.registerEventValue(PlaceholderAPIEvent.class, Player.class,
				new Getter<Player, PlaceholderAPIEvent>() {
					@Override
