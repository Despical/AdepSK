...
@Examples({ "if event-hologram allows placeholders:", "if placeholders in event-hologram are enabled:",
		"if hologram {_variable} disallows placeholders:", "if {_holo} doesn't allow placeholders:",
