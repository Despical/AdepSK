...
@Examples({ "allow placeholders in the created hologram", "disable placeholders for {_hologram}",
		"enable the placeholders in the holo", "disallow placeholders in {_holograms::*}" })
@Since("1.0.0")
