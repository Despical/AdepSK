package me.adeptr.adepsk.holo.skript.effects;
...
@Examples({ "hide the last created hologram from the player", "reveal holos {holograms::*} to {_players::*}",
		"reset the visibility of all holograms", "make the last holo invisible by default",
...
public class EffHologramVisibility extends Effect {
	...
	static {
		Skript.registerEffect(EffHologramVisibility.class, "hide [holo[gram][s]] %holograms% (from|for) %players%",
	...
	public String toString(@Nullable Event e, boolean debug) {
		...
		case DEFAULT_INVISIBLE:
		case DEFAULT_VISIBLE:
			return "make " + holograms.toString(e, debug) + (mode == Modes.DEFAULT_INVISIBLE ? " in" : " ")
					+ "visible by default";
		default:
			return null;
		}
