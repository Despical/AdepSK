...
@Description({
		"Deletes a hologram. The hologram type has the delete changer already, but this effect exists for variables. "
...
@Examples({ "delete holo {_var}", "remove holograms {_holograms::*}" })
@Since("1.0.0")
public class EffDeleteHologram extends Effect {

	static {
		Skript.registerEffect(EffDeleteHologram.class, "(delete|remove|clear) holo[gram][s] %holograms%");
	}
