...
@Examples({ "make 1st line of last holo click-able", "make all lines of {_holo} untouchable",
		"make the last line of {_hologram} non-interactive", "make line 2 of the created hologram interactive" })
@Since("1.0.0")
public class EffMakeHologramLineInteractive extends Effect {

	static {
		Registry.newEffect(EffMakeHologramLineInteractive.class,
