package me.adeptr.adepsk.holo.skript.events;
...
import me.adeptr.adepsk.holo.util.HologramLinePickupEvent;
...
public class EvtHologramLineTouch extends SkriptEvent {
	...
	static {
		Skript.registerEvent("Hologram Line Touch", EvtHologramLineTouch.class, HologramLinePickupEvent.class,
				...
				.examples("on hologram touch:", "\tif hologram line is a stone:",
						"\t\tgive item of event-hologram-line to player")
				.since("1.0.0");

		EventValues.registerEventValue(HologramLinePickupEvent.class, Player.class,
				new Getter<Player, HologramLinePickupEvent>() {
					@Override
					public Player get(HologramLinePickupEvent e) {
						return e.getPlayer();
					}
				}, 0);
		EventValues.registerEventValue(HologramLinePickupEvent.class, Hologram.class,
				new Getter<Hologram, HologramLinePickupEvent>() {
					@Override
					public Hologram get(HologramLinePickupEvent e) {
						return e.getHologram();
					}
				}, 0);
		EventValues.registerEventValue(HologramLinePickupEvent.class, HologramLine.class,
				new Getter<HologramLine, HologramLinePickupEvent>() {
					@Override
					public HologramLine get(HologramLinePickupEvent e) {
						return e.getHologramLine();
					}
				}, 0);
		EventValues.registerEventValue(HologramLinePickupEvent.class, ItemType.class,
				new Getter<ItemType, HologramLinePickupEvent>() {
					@Override
